...
const VirtualRow = React.memo(function VirtualRow({ data, index }) {
  const { rows, prepareRow, rowStyle, selectedBg, rowNavigation, fontPx, selectedIndexRef, onSelect, rowHeight, pinnedLeft } = data;
...
export const RealTable = React.forwardRef(function RealTable(
  ...
  return (
    <div
      ...
      onKeyDown={onKeyDown}
      style={{ width: '100%', height: parseFloat(height), overflow: 'auto', outline: 'none', ...style }}
    >
      <div
        {...tableProps}
